    ...
    <Container maxW="container.xl" pt="10">
      ...
      <Section delay={0.1}>
        ...
        <Paragraph>
          ...
          pesquisa tecnológica no Brasil. Tem umas das maiores redes de
          assitência médica do Brasil. A empresa nasceu em 2009 com o objetivo
          de projetar uma vacina para o pândemia de H1N1 que assolou o povo
          brasileiro e hoje existem 100 cooperativas médicas, que prestam
          assitência para mais de 3 milhões de clientes e para 10 mil empresas
          em todo país.
        </Paragraph>
        <Paragraph>
          Referência em tratamento viral, a rede colaborativa da empresa conta
          com mais de 80 mil profissionais, com 50 hospitais credenciados, além
          de pronto-atendimentos, laboratórios, ambulâncias e uma faculdade.
          Agende uma <NextLink href="/scheduling" />
          <Link>consulta</Link>.
        </Paragraph>
      ...
      <Section delay={0.4}>
        ...
        <AboutSection>
          ...
          Continua o serviço por todo o Brasil com uma visão expansionista para
          o mundo.
        </AboutSection>
      </Section>
    </Container>
